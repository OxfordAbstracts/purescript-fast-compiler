...
check_failing_build_unit!(f_MonoKindDataBindingGroup, "MonoKindDataBindingGroup");
...
check_failing_build_unit!(f_PolykindInstantiatedInstance, "PolykindInstantiatedInstance");
...
check_failing_build_unit!(f_RowsInKinds, "RowsInKinds");
