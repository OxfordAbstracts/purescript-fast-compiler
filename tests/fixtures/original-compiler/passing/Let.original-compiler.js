...
var test4 = function (dictPartial) {
    var f = function (x) {
        return function (v) {
            ...
            throw new Error("Failed pattern match at Main (line 23, column 11 - line 23, column 29): " + [ x.constructor.name, v.constructor.name ]);
        };
    };
